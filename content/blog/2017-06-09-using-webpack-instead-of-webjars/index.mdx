...
badges:
  - -play-green?logo=scala
  - -sbt-blue?logo=scala
  - -webpack-lightblue?logo=webpack
tags:
  - Play
  - SBT
  - WebPack
...
After setting up your standard Play Framework project and getting some partial functionality up and running on the server side,
